...
cfu.Goe2.test <- t.test(cfu.2$dif.1, mu = 0, alternative = "less")
# one-sided: P = 0.1314 (alternative = "less" -> does phage ameliorate?)
# answer = no

# 2) SPO1: one-sided, paired t-test
cfu.SPO1.test <- t.test(cfu.2$dif.2, mu = 0, alternative = "less")
# one-sided: P = 0.06147
# answer = maybe

# 3) Phage (Goe2 and SPO1), paired t-test: does "phage" ameliorate
cfu.both.test <- t.test(c(cfu.2$dif.1, cfu.2$dif.2), mu = 0, alternative = "less")
# one-sided: P = 0.01357
# answer = yes

# 4) Difference in Goe2 vs SPO1 slopes, paired
cfu.GvsS.test <- t.test(c(cfu.2$Goe2, cfu.2$SPO1), mu = 0, alternative = "two.sided")
...
pfu.both.test <- t.test(c(pfu$dif.1, pfu$dif.2), mu = 0, 
                           alternative = "less")
# one-sided: P = 0.2765
# answer: no

# 4) Difference in Goe2 vs SPO1 
pfu.GvsS.test <- t.test(c(pfu$Goe2, pfu$SPO1), mu = 0, 
                           alternative = "two.sided")
# two-sided: 0.002264
# answer: yes ( Goe2 virospore slope more negative than SPO1 virospore slope)
...
```{r}
# subset slopes by deletion host, assay type (CFU vs. PFU), and group
